...
export const en = {
    ...
    ui: {
        ...
        poi_discovered: "{title} DISCOVERED",
        poi_discovered_title: "LOCATION DISCOVERED",
        enemy_encountered: "{name} ENCOUNTERED",
        enemy_encountered_title: "NEW THREAT ENCOUNTERED",
        boss_encountered: "{name} ENCOUNTERED",
        boss_encountered_title: "BOSS ENCOUNTERED",
