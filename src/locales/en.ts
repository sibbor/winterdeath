...
export const en = {
    ...
    ui: {
        ...
        discovery_popups_sub: "Show notifications for progress",
        challenge_popups: "CHALLENGE POPUPS",
        challenge_popups_sub: "Show notifications for challenges",
        next_rank: "NEXT RANK",
        ...
        discovered_enemy: "ENEMY DISCOVERED",
        discovered_boss: "BOSS DISCOVERED",
    ...
    tips: [
        ...
        "Press [Space] to DODGE, pushing back enemies and getting away.",
        ...
        "Adventure Log - Keep track on your journey and read details about your findings",
        "Statistics - Track your game time, run distnace, K/D ratio, Weapon logs and much more",
        "Challenges - Lots of challenges to complete. Activate tracking from the Adventure Log",
