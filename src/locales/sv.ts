export const sv = {
    ...
    ui: {
        ...
        sp_hint_rankup: "Tjäna Skill Points genom att hitta samlarobjekt, rädda familjen, döda bossar eller gå upp i rang ({xp} XP behövs)",
        ...
        reset_confirm_desc: "Detta kommer permanent att radera alla framsteg, inklusive vapen, färdigheter och räddad familj. Detta kan inte ångras. Är du säker?",
