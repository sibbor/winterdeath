            ...
            <div className="flex flex-col items-center justify-center py-4 max-w-xl mx-auto text-center space-y-8">
                ...
                <div className="flex gap-6">
                    <button
                        ...
                        className="px-8 py-4 bg-gray-900 border-2 border-gray-600 text-white font-bold uppercase tracking-widest hover:bg-gray-800 hover:border-white transition-all skew-x-[-5deg]"
                    >
                    ...
                    <button
                        ...
                        className="px-8 py-4 bg-red-700 border-2 border-red-500 text-white font-bold uppercase tracking-widest hover:bg-red-600 hover:scale-105 transition-all skew-x-[-5deg] shadow-[0_0_20px_rgba(220,38,38,0.5)]"
                    >
