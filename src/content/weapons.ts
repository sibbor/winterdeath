...
export interface WeaponStats {
  id: WeaponID; // Stenhårt typad till endast riktiga vapen!
  displayName: string;
...
WEAPONS[WeaponID.SMG] = {
  id: WeaponID.SMG, displayName: 'weapons.smg', category: WeaponCategory.PRIMARY, behavior: WeaponBehavior.PROJECTILE, defaultDamageType: DamageType.BALLISTIC,
...
WEAPONS[WeaponID.SHOTGUN] = {
  id: WeaponID.SHOTGUN, displayName: 'weapons.shotgun', category: WeaponCategory.PRIMARY, behavior: WeaponBehavior.PROJECTILE, defaultDamageType: DamageType.BALLISTIC,
...
WEAPONS[WeaponID.RIFLE] = {
  id: WeaponID.RIFLE, displayName: 'weapons.rifle', category: WeaponCategory.PRIMARY, behavior: WeaponBehavior.PROJECTILE, defaultDamageType: DamageType.BALLISTIC,
...
WEAPONS[WeaponID.PISTOL] = {
  id: WeaponID.PISTOL, displayName: 'weapons.pistol', category: WeaponCategory.SECONDARY, behavior: WeaponBehavior.PROJECTILE, defaultDamageType: DamageType.BALLISTIC,
...
WEAPONS[WeaponID.REVOLVER] = {
  id: WeaponID.REVOLVER, displayName: 'weapons.revolver', category: WeaponCategory.SECONDARY, behavior: WeaponBehavior.PROJECTILE, defaultDamageType: DamageType.BALLISTIC,
...
WEAPONS[WeaponID.GRENADE] = {
  id: WeaponID.GRENADE, displayName: 'weapons.grenade', category: WeaponCategory.THROWABLE, behavior: WeaponBehavior.THROWABLE, defaultDamageType: DamageType.EXPLOSION,
...
WEAPONS[WeaponID.MOLOTOV] = {
  id: WeaponID.MOLOTOV, displayName: 'weapons.molotov', category: WeaponCategory.THROWABLE, behavior: WeaponBehavior.THROWABLE, defaultDamageType: DamageType.BURN,
...
WEAPONS[WeaponID.FLASHBANG] = {
  id: WeaponID.FLASHBANG, displayName: 'weapons.flashbang', category: WeaponCategory.THROWABLE, behavior: WeaponBehavior.THROWABLE, defaultDamageType: DamageType.PHYSICAL,
...
WEAPONS[WeaponID.MINIGUN] = {
  id: WeaponID.MINIGUN, displayName: 'weapons.minigun', category: WeaponCategory.SPECIAL, behavior: WeaponBehavior.PROJECTILE, defaultDamageType: DamageType.BALLISTIC,
  damage: 18, fireRate: 50, bulletSpeed: 75, magSize: 500, reloadTime: 5000, range: 25, spread: 0.18,
  icon: PNG_PATH + 'minigun.png', iconIsPng: true,
  impactType: EnemyDeathState.SHOT, statusEffect: null
};

WEAPONS[WeaponID.FLAMETHROWER] = {
  id: WeaponID.FLAMETHROWER, displayName: 'weapons.flamethrower', category: WeaponCategory.SPECIAL, behavior: WeaponBehavior.CONTINUOUS, defaultDamageType: DamageType.BURN,
...
WEAPONS[WeaponID.ARC_CANNON] = {
  id: WeaponID.ARC_CANNON, displayName: 'weapons.arc_cannon', category: WeaponCategory.SPECIAL, behavior: WeaponBehavior.CONTINUOUS, defaultDamageType: DamageType.ELECTRIC,
