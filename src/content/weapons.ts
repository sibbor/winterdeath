...
export const WEAPONS: Record<WeaponType, WeaponStats> = {
  ...
  [WeaponType.SHOTGUN]: { name: WeaponType.SHOTGUN, displayName: 'weapons.shotgun', category: WeaponCategory.PRIMARY, baseDamage: 15, damage: 15, fireRate: 1000, magSize: 6, reloadTime: 3000, range: 8, spread: 0.35, color: '#ef4444', icon: ICONS.SHOTGUN },
  [WeaponType.RIFLE]: { name: WeaponType.RIFLE, displayName: 'weapons.rifle', category: WeaponCategory.PRIMARY, baseDamage: 35, damage: 35, fireRate: 200, magSize: 25, reloadTime: 2500, range: 20, spread: 0.05, color: '#ef4444', icon: ICONS.RIFLE },
  ...
  [WeaponType.REVOLVER]: { name: WeaponType.REVOLVER, displayName: 'weapons.revolver', category: WeaponCategory.SECONDARY, baseDamage: 60, damage: 60, fireRate: 800, magSize: 6, reloadTime: 2500, range: 25, spread: 0.01, color: '#fbbf24', icon: ICONS.REVOLVER },
  ...
  [WeaponType.MOLOTOV]: { name: WeaponType.MOLOTOV, displayName: 'weapons.molotov', category: WeaponCategory.THROWABLE, baseDamage: 10, damage: 10, fireRate: 4, magSize: 5, reloadTime: 0, range: 15, spread: 0, color: '#10b981', icon: ICONS.MOLOTOV },
  [WeaponType.FLASHBANG]: { name: WeaponType.FLASHBANG, displayName: 'weapons.flashbang', category: WeaponCategory.THROWABLE, baseDamage: 0, damage: 0, fireRate: 10, magSize: 5, reloadTime: 0, range: 15, spread: 0, color: '#10b981', icon: ICONS.FLASHBANG },

  // Special
  [WeaponType.MINIGUN]: { name: WeaponType.MINIGUN, displayName: 'weapons.minigun', category: WeaponCategory.SPECIAL, baseDamage: 15, damage: 15, fireRate: 50, magSize: 200, reloadTime: 5000, range: 25, spread: 0.2, color: '#3b82f6', icon: ICONS.MINIGUN },
