...
const ScreenTeleport: React.FC<ScreenTeleportProps> = ({ onJump, onCancel, initialCoords }) => {
    ...
    return (
        <GameModalLayout title={t('ui.teleport_title')} titleColorClass="text-white" maxWidthClass="max-w-2xl">
            <div className="space-y-8" onKeyDown={handleKeyDown}>
                <div className="flex gap-4 justify-center items-center">
                    <div className="flex flex-col items-start gap-2">
                        ...
                        className="bg-black/80 border-2 border-blue-900 text-white p-4 text-xl font-mono w-40 focus:border-blue-500 outline-none text-center shadow-[0_0_15px_rgba(37,99,235,0.3)]" 
                        placeholder="0"
                        autoFocus={!initialCoords} // Auto focus if manual entry
                        />
                    </div>
                    <div className="flex flex-col items-start gap-2">
