                ...
                <div className="flex-1 grid grid-cols-2 gap-6 content-start">
                        ...
                        <div className="bg-black border border-gray-800 p-6">
                            ...
                            <div className="space-y-3 text-sm">
                                ...
                                <div className="flex justify-between items-end"><span className="text-gray-500">{t('ui.sectors_completed')}</span><span className="text-white font-mono text-lg">{stats.missionsCompleted}</span></div>
