...
export const GEOMETRY = {
  ...
  treeTrunk: new THREE.CylinderGeometry(0.3, 0.5, 3.5, 7), // Stylized tapered trunk
  treeLeaves: new THREE.ConeGeometry(3, 18, 7), // Legacy fallback
  foliageCluster: new THREE.DodecahedronGeometry(1.0, 0), // Puffy foliage
